...
public class TestDatabaseAccess {
	...
	public void wasInsertedBuy() throws DatabaseLayerException {
		...
		// Assert
		assertEquals("Junit test #4", key > 0, true);
	...
	public void wasRetrievedPriceDatabaselayer() throws DatabaseLayerException {
		...
		// Assert
		assertNotNull("Price can't be fetched", foundPrice);
		
		assertEquals("Dummy", expected, foundPrice.getParkingPrice());
	...
	public void wasRetrievedPriceControllayer() {
		...
		// Act
		PPrice foundPrice = ctrPrice.getCurrentPrice();

		// Assert
		assertEquals("Yeah, Yeah. You silly goose.... ;)", expected, foundPrice.getParkingPrice());
